...
IMOGI_ROLE_PERMISSIONS: dict[str, list[tuple[str, dict]]] = {
	...
	"IMOGI Manager": [
		...
		("IMOGI Kitchen Station", {"read": 1, "write": 1, "create": 1, "delete": 1}),
		("IMOGI Restaurant Floor", {"read": 1, "write": 1, "create": 1, "delete": 1}),
		("IMOGI Restaurant Area", {"read": 1, "write": 1, "create": 1, "delete": 1}),
		("IMOGI Restaurant Table", {"read": 1, "write": 1, "create": 1, "delete": 1}),
	],
	"IMOGI Area Manager": [
		("IMOGI POS Settings", {"read": 1}),
	...
	"IMOGI Waiter": [
		...
		("IMOGI Restaurant Floor", {"read": 1, "write": 1}),
		("IMOGI Restaurant Area", {"read": 1, "write": 1}),
	...
	"IMOGI Supervisor": [
		...
		("IMOGI Restaurant Table", {"read": 1, "write": 1, "create": 1}),
		("IMOGI Restaurant Floor", {"read": 1, "write": 1, "create": 1}),
		("IMOGI Restaurant Area", {"read": 1, "write": 1, "create": 1}),
		("IMOGI POS Table Reservation", {"read": 1, "write": 1, "create": 1}),
		("IMOGI POS Waiting List", {"read": 1, "write": 1, "create": 1}),
		("POS Invoice", {"read": 1}),
		("Purchase Order", {"read": 1}),
