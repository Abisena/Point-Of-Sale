...
WORKSPACE_SECTIONS = [
	{
		...
		"links": [
			...
			{"label": "IMOGI POS Order", "link_type": "DocType", "link_to": "IMOGI POS Order", "onboard": 1},
			{"label": "POS Dashboard", "link_type": "Page", "link_to": "imogi-pos-dashboard"},
...
WORKSPACE_SHORTCUTS = [
	...
	{"color": "Orange", "label": "IMOGI POS Order", "link_to": "IMOGI POS Order", "type": "DocType"},
	...
	{"color": "Blue", "label": "POS Dashboard", "link_to": "imogi-pos-dashboard", "type": "Page"},
...
def build_workspace_content(*, variant: str = "restaurant") -> str:
	if variant == "umkm":
		header = (
			...
			'<span class="text-muted">Semua modul IMOGI — menu terkunci otomatis sesuai paket langganan.</span>'
		)
	else:
		header = (
	...
	blocks = [
		...
		{"id": "sc2", "type": "shortcut", "data": {"shortcut_name": "IMOGI POS Order", "col": 2}},
		...
		{"id": "sc5", "type": "shortcut", "data": {"shortcut_name": "POS Dashboard", "col": 2}},
